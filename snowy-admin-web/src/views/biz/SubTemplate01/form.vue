<template>
	<xn-form-container
		:title="formData.subtemplateId ? '编辑SubTemplate01' : '增加SubTemplate01'"
		:width="700"
		v-model:open="open"
...
<script setup name="subtemplate01Form">
	...
	const onSubmit = () => {
		formRef.value
			...
			.then(() => {
				...
				subtemplate01Api
					.subtemplate01SubmitForm(formDataParam, formDataParam.subtemplateId)
					.then(() => {
						onClose()
						emit('successful')
					})
