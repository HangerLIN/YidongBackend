 ...
 */
package vip.xiaonuo.biz.modular.basicinfo.param;
...
@Getter
@Setter
public class ProjectBasicInfoEditParam {

    /** 主键，自增 */
    @Schema(description = "主键，自增", requiredMode = Schema.RequiredMode.REQUIRED)
