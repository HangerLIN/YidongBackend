...
<!--&lt;!&ndash;					<a-form-item label="模版ID" name="templateId">&ndash;&gt;-->
<!--&lt;!&ndash;						<a-input v-model:value="searchFormState.templateId" placeholder="请输入模版ID" />&ndash;&gt;-->
...
<!--			</template>-->
			<template #bodyCell="{ column, record }">
				<template v-if="column.dataIndex === 'action'">
					<a-space>
						<a @click="formRef.onOpen(record)" v-if="hasPerm('subtemplate001Edit')">填报</a>
...
<!--						</a-popconfirm>-->
	...
	<Form ref="formRef" :cyc="epoch" :TemplateId="props.TemplateId" @successful="tableRef.refresh()" />
</template>
