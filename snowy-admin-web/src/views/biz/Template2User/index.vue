...
<!--			</template>-->
			<template #bodyCell="{ column, record }">
				<template v-if="column.dataIndex === 'action'">
					<a-space>
						<a @click="formRef.onOpen1(record)" v-if="hasPerm('template2Edit')">选择</a>
...
<!--						</a-popconfirm>-->
	...
	<Form ref="formRef" :TemplateId="props.TemplateId" :cyc="epoch"  @successful="tableRef.refresh()" />
</template>
